                        ...
                        <script type="application/ld+json">
                          {
                            ...
                            "image": "' . rootUrl() . '/' . $gallery->gallery_image[0] . '"
                          }
                        </script>
                      ';
    $doc->addCustomTag($jsonldProduct);
?>

<article class="main main--product" itemscope itemtype="https://schema.org/Article" itemprop="articleBody">
  ...
  <section class="product">
      ...
      <div class="product__topright">
        ...
        <div class="product__downloads">
          ...
          <div class="product__dlitem">
            ...
            <p class="product__dlnum text__line text__line--nogap"><?php echo isset($cads) ? count($cads) : "0"; ?> item<?php echo (isset($cads) && (count($cads) > 1 || count($cads) == 0)) ? "s" : ""; ?></p>
          </div>
          <?php endif; ?>
        </div>
      </div>
    ...
    <section class="product__main" itemprop="articleSection">
      <section class="product__content" itemprop="mainEntityOfPage">
      ...
      <aside class="aside aside--product">
        ...
        <section class="aside__section aside__section--featured">
          ...
          <?php
            ...
            // Limit the number of featured projects
            $limit = count($featuredArray) < 3 ? count($featuredArray) : 3;
